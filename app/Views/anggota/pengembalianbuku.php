                        ...
                        foreach ($peminjaman as $k) : ?>
                            <tr class="">
                                ...
                                <td class="text-center">
                                    <img src="<?= base_url('assets/cover/' . $k['cover']); ?>" width="75px" height="75px" alt=""><br>
                                    <p><?= $k['kode_buku']; ?></p>
                                </td>
                                ...
                                <td class="text-center">
                                    <button class="dropdown-item d-flex align-items-center btn btn-info" type="button" data-bs-toggle="modal" data-bs-target="#ModalDetail<?= $k['id_pinjam']; ?>">
                                        Detail
                                    </button>
                                </td>
                            </tr>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 80%;">
            <div class="modal-content">
                <div class="modal-header border pb-3 ">
                    <h5 class="modal-title" id="exampleModalLabel2">Detail Pengembalian Buku</h5>
                </div>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <b>Keterlambatan : </b> <?= $k['keterlambatan'] ? $k['keterlambatan'] . ' Hari' : 'Tidak ada'; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center">
